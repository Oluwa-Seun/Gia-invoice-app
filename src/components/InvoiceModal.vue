    ...
    <form @submit.prevent="submitForm" class="invoice-content">
      ...
      <div class="save flex">
        ...
        <div class="right flex">
          <button v-if="!editInvoice" type="submit" @click="saveDraft" class="dark-purple"> Draft</button>
          <button v-if="!editInvoice" type="submit" @click="publishInvoice" class="purple">Create</button>
